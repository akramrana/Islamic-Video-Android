...
import com.akramhossain.islamicvideo.CmsActivity;
...
public class CmsJsonFromUrlTask extends AsyncTask<Void, Void, String> {
    ...
    protected void onPostExecute(String result) {
        ((CmsActivity) activity).parseJsonResponse(result);
        //dialog.dismiss();
