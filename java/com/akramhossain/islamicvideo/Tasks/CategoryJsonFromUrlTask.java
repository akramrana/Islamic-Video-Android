...
import com.akramhossain.islamicvideo.CategoryActivity;
...
public class CategoryJsonFromUrlTask{

    private Activity activity;
    private String url;
    private ProgressDialog dialog;
    private final static String TAG = CategoryJsonFromUrlTask.class.getSimpleName();
    ProgressBar progressBar;

    public CategoryJsonFromUrlTask(Activity activity, String url) {
        super();
    ...
    private void getData(){
        ...
        String tag_string_req = "category_api";
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ((CategoryActivity) activity).parseJsonResponse(response);
                } catch (Exception e) {
                    e.printStackTrace();
...
//        ((CategoryActivity) activity).parseJsonResponse(result);
//        //dialog.dismiss();
//        progressBar.setVisibility(View.GONE);
//        Log.i(TAG, result);
//    }
