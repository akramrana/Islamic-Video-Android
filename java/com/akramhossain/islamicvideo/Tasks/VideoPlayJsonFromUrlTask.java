...
public class VideoPlayJsonFromUrlTask{

    private Activity activity;
    private String url;
    private final static String TAG = VideoPlayJsonFromUrlTask.class.getSimpleName();
    ProgressBar progressBar;

    public VideoPlayJsonFromUrlTask(Activity activity, String url) {
        super();
    ...
    private void getData(){
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ((VideoPlayActivity) activity).parseJsonResponse(response);
                } catch (Exception e) {
                    e.printStackTrace();
...
//        ((VideoPlayActivity) activity).parseJsonResponse(result);
//        //dialog.dismiss();
//        progressBar.setVisibility(View.GONE);
//        Log.i(TAG, result);
//    }
