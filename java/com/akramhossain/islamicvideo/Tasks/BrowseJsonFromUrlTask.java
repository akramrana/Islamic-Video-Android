...
public class BrowseJsonFromUrlTask {

    private Activity activity;
    private String url;
    private final static String TAG = BrowseJsonFromUrlTask.class.getSimpleName();
    ProgressBar progressBar;

    public BrowseJsonFromUrlTask(Activity activity, String url) {
        super();
    ...
    private void getData(){
        ...
        String tag_string_req = "browse_pai";
        ...
        StringRequest strReq = new StringRequest(Request.Method.GET,url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ((BrowseActivity) activity).parseJsonResponse(response);
                } catch (Exception e) {
                    e.printStackTrace();
...
//        ((BrowseActivity) activity).parseJsonResponse(result);
//        //dialog.dismiss();
//        progressBar.setVisibility(View.GONE);
//    }
//
