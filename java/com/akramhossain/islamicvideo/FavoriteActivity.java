...
import com.akramhossain.islamicvideo.Adapter.FavoriteViewAdapter;
...
public class FavoriteActivity extends AppCompatActivity
    ...
    private FavoriteViewAdapter rvAdapter;
...
//        navigationView.setNavigationItemSelectedListener(this);
        ...
        recyclerview = (RecyclerView) findViewById(R.id.favorite_video_list);
    ...
    private void getDataFromLocalDb() {
        if (isInternetPresent) {
            SQLiteDatabase db = dbhelper.getWritableDatabase();
            String sql = "select * from favorite order by favorite_id desc limit " + offset + "," + limit;
            Log.i(TAG, sql);
    ...
    private void setRecyclerViewAdapter() {
        ...
        rvAdapter = new FavoriteViewAdapter(FavoriteActivity.this, videos);
